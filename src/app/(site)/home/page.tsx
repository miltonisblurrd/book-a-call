...
/**
 * Full pre-rebrand homepage — unlisted (not linked from nav).
 * Public root `/` serves the coming-soon landing during the rebrand.
 */
const { page, metadata, jsonLd } = getWebflowPageSeo("index.html", "/home");
